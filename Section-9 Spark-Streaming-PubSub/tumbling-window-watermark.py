...
pubsub_subscription_path ="projects/44942850786/locations/us-central1/subscriptions/events_with_late_data_sub"
...
tumbling_window_agg_watermark = df_final \
                    .withWatermark("event_date", "2 minutes") \
                    .groupBy(
                        window("event_date","1 minute"),
                        "traffic_source"
                    ) \
                    .agg(
                        F.count("session_id")
...
query = (
    tumbling_window_agg_watermark.writeStream \
    .outputMode("complete") \
